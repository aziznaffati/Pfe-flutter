...
class MiseCPage extends StatefulWidget {
  @override
  _MiseCPage createState() => _MiseCPage();
}

class _MiseCPage extends State<MiseCPage> {
                    ...
                    child: Column(
                        ...
                        children: [
                          Container(
                              ...
                              child: Text("Mise à jour Chariot",
                                  style: TextStyle(
                                      fontSize: 16,
