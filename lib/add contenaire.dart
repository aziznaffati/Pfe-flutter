...
import 'addchariot.dart';
import 'misechariot.dart';
            ...
            FutureBuilder<List<Chariot>>(
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    Container(
                        child: Text('Total des chariots: ${snapshot.data.length}',
                            style: TextStyle(
                              color: Colors.blue,
                              fontSize: 20,
                            ))),
                            ...
                            child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text('Num de série Chariot:${chariot.snC}',
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 20)),
